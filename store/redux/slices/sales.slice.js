        ...
        items: [
            ...
            },
            {
                ...
                Ubicacion: {
                    ...
                    Canton: 1,
                    Distrito: 5,
                    OtrasSenas: '700 NORTE DE PALI DE SAN RAFAEL DE ALAJUELA',
                },
                Fax: {
                    CodigoPais: 506,
...
export const salesSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        //     (state, { payload }) => {
        //         console.log('getUserProfile.matchFulfilled:', state, payload);
        //         return {
        //             ...state,
        //             name: payload.name,
        //             image: payload.image,
        ...
        //
        builder.addMatcher(
            salesApi.endpoints.getProducts.matchFulfilled,
            (state, { payload }) => {
                console.log(
                    'salesApi.getProducts.matchFulfilled:',
                    state,
                    payload
                );
                return {
        ...
        builder.addMatcher(
            salesApi.endpoints.getVendors.matchFulfilled,
            (state, { payload }) => {
                console.log(
                    'salesApi.getVendors.matchFulfilled:',
                    state,
                    payload
                );
                return {
        ...
        //     (state, { payload }) => {
        //         console.log('updateUser.matchFulfilled:', state, payload);
        //         return { ...state, name: payload.name, image: payload.image };
        //     }
        // );
    },
});
export const { resetSales, add, reset } = salesSlice.actions;
